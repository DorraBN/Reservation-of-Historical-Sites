                   ...
                   <table class="w-full whitespace-no-wrap">
                     <thead>
                       ...
                       >
                         ...
                         <th class="px-3 py-3">IdDestination</th>
  ...
  ?>
    ...
    <td class="px-4 py-2">
      <div>
                         ...
                         <td class="px-3 py-3 text-sm w-25px">
                         <?php echo htmlentities($row['id_destination']);?>
                         </td>
                         <td class="px-4 py-3 text-xs">
                           <span
                             class="font-semibold"
                           >
                           <?php echo htmlentities($row['adresse']);?>
                           </span>
                         </td>
                         <td class="px-4 py-3 text-sm ">
                         
                         <?php echo htmlentities($row['description']);?><br><br>
                         
                         </td>
                         <td class="px-4 py-3">
                           <div class="flex items-center space-x-4 text-sm">
                           <a href="edit.php?id=<?php echo $row['id_destination']; ?>">
                             <button id="myBtn1"
                             ...
                             <a href="delete.php?id=<?php echo $row['id_destination']; ?>">
                             <button
                               class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                               aria-label="Delete"
                             >
