...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Manage Booking -TuniHistoire</title>
    <link
        ...
        <ul>
          ...
          <li class="relative px-6 py-3">
              ...
              <li
                  class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                >
                  <a class="w-full" href="pages/404.html"></a>
                </li>
                <li
                  class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                >
               ...
               <table class="w-full whitespace-no-wrap">
                 <thead>
                   ...
                   ><th class="px-4 py-3">Display</th>
                     <th class="px-4 py-3">EmailUser</th>
  ...
  INNER JOIN reservation ON reserver.num_reserv = reservation.num_reserv ";
  ...
  ?>
      ...
      <div>
                     ...
                     <a href="confirm.php?id=<?php echo $row['num_reserv']; ?>"></a>
                     <button  class="btn btn-green"><span class="icon">&#10004;</span></button>
                     <a href="cancel.php?id=<?php echo $row['num_reserv']; ?>"></a>
  ...
  while ($row = mysqli_fetch_array($result)) {
                    if(isset($_POST["green"])){
                      $sq = " UPDATE reservation SET valid_reservation =".'confirmed."';
